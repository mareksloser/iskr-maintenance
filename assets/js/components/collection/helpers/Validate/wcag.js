...
export const validateWcagProp = (value, propName, component) => {
  if (value === undefined || String(value).length === 0) {
    govWarningLog(`[${component}]: The (${propName}) attribute is important for correct accessibility.`);
  }
};
export const validateWcagRef = (referenceId, name, component) => {
...
export const validateWcagLabelFor = (inputId, labelledBy, component) => {
...
export const validateWcagLabel = (label, labelledBy, component) => {
